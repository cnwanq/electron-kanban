...
function connectPort(portPath) {
  ...
  port.on('data', function (data) {
    if (data.length > 0 && data.length == 41) {
      ...
      let model1 = String.fromCharCode(data[15])+ String.fromCharCode(data[16]);
      // console.log('model1:'+ model1);
      let model2Hex = data[17].toString(16)+data[18].toString(16);
      let model2 = String.fromCharCode(data[17])+ String.fromCharCode(data[18]);
      // console.log('model1:'+ model1);
      let model3Hex = data[19].toString(16)+data[20].toString(16);
      let model3 = String.fromCharCode(data[19])+ String.fromCharCode(data[20]);
      let model4Hex = data[21].toString(16)+data[22].toString(16);
      let model4 = String.fromCharCode(data[21])+ String.fromCharCode(data[22]);
      ...
      getElementById('labeValue4').innerHTML = (actual*1.0/plan*1.0).toFixed(2);
